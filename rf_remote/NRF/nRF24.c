...
#define NRF24_CSN_HIGH		HAL_GPIO_WritePin(GPIO_NRF_CSN_GPIO_Port, GPIO_NRF_CSN_Pin, GPIO_PIN_SET)
#define NRF24_CSN_LOW		HAL_GPIO_WritePin(GPIO_NRF_CSN_GPIO_Port, GPIO_NRF_CSN_Pin, GPIO_PIN_RESET)

#define NRF24_CE_HIGH		HAL_GPIO_WritePin(GPIO_NRF_CE_GPIO_Port, GPIO_NRF_CE_Pin, GPIO_PIN_SET)
#define NRF24_CE_LOW		HAL_GPIO_WritePin(GPIO_NRF_CE_GPIO_Port, GPIO_NRF_CE_Pin, GPIO_PIN_RESET)
...
void nRF24_Init(SPI_HandleTypeDef *hspi)
{
	...
	nRF24_SetRetries(0x0F, 0x07); // 4000us, 7 times
