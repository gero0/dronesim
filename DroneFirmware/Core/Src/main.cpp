...
//      uint8_t buffer[sizeof(Vector3) + sizeof(Rotation) + 2] = {11, 37};
//      __disable_irq();
...
//      __enable_irq();
//      memcpy((void *) &buffer[2], &accel, sizeof(Vector3));
//      memcpy((void *) &buffer[2 + sizeof(Vector3)], &rot, sizeof(Rotation));
//      HAL_UART_Transmit(&huart3, buffer, sizeof(buffer), 10);
//      HAL_Delay(50);
